        ...
        if len(cad) < 3:
            ...
            ######### Intermedio de la cadena
                ...
                if cad[i+1] == "+":
                    ...
                    if cad[i+2] == "+":
                        ops.append("A " + "$"+ str(n-1))
                    ops.append("ST $"+ str(n))
                    n +=1
                elif cad[i+1] == "-":
                    ops.append("S " + str(cad[i]))
                    if cad[i+2] == "-":
                        ops.append("S " + "$"+ str(n-1))
                    ops.append("ST $"+ str(n))
                    n +=1
                elif cad[i+1] == "*":
                    ops.append("M " + str(cad[i]))
                    if cad[i+2] == "*":
                        ops.append("M " + "$"+ str(n-1))
                    ops.append("ST $"+ str(n))
                    n +=1
                elif cad[i+1] == "/":
                    ...
                    ops.append("ST $"+ str(n))
                    n +=1
                if cad[i+1] not in symb:
                    ops.append("L "+ str(cad[i]))
                    if cad[i+2] not in symb: ## Revisa si en 3 posiciones adelantes no hay operando para guardar
                        ops.append("ST $"+ str(n))
                        n +=1
        i +=1
